...
<html lang="en">
    <head>
        ...
        <?php if($_SESSION[user_id]=666) {echo '<link rel="stylesheet" href="../css/666.css" type="text/css">';} ?>
            ...
            <div class="container-fluid shadow rounded-lg" id="content">
                ...
                <div class="row">
                    <div class="col-xl-10 col-md-9">
                        <?php include('../includes/admin/boardscreat_view.php'); ?>
                        <?php include('../includes/admin/boardscreat_form.php'); ?>
