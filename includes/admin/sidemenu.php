    ...
    <div class="form-group <?php echo $pwdclasserr; ?>">
        ...
        <a class="text-white" href="../">
        <div class="my-2  btn btn-primary btn-block rounded-pill" >Site Home</div></a>
        <a class="text-white" href="users.php">
        <div class="my-2  btn btn-primary btn-block rounded-pill" >Edit Users</div></a>
        <a class="text-white" href="">
        <div class="my-2  btn btn-primary btn-block rounded-pill" >Board Edit (soon)</div></a>
        <a class="text-white" href="javascript:history.go(-1)">
        <div class="my-2  btn btn-primary btn-block rounded-pill" >Back</div></a>
