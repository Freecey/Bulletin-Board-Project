    ...
    if (isset($_POST['new_post_submit'], $_POST['new_post'])) {
        ...
        if (isset($_SESSION['user_id'])) {
            if (!empty($new_post_msg)) {
                ...
                $insert ->execute(array($topic_id, $new_post_msg, $_SESSION['user_id'], $user_sign));
...
<?php 
    ...
    <form id="newPostArea" method="post">
        <div class="form-group">
            <textarea id="text_editor" name="new_post" type="text" class="form-control" placeholder="Your message"></textarea>
        </div>
